...
function resetSpeeds() {
  ...
  return new Promise((resolve, reject) => {
    chrome.storage.sync.remove(['minSpeed', 'slowSpeed', 'mainSpeed', 'fastSpeed', 'maxSpeed', 'periodKeySpeed', 'commaKeySpeed', 'extensionEnabled', 'hotkeysEnabled', 'autoSkipFeatureShown'], function() {
      resolve();
    });
  });
}
